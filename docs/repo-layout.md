...
- `skills/datocms-plugin/` is the public plugin entrypoint. It covers new plugin scaffolds, existing plugin maintenance, SDK hook work, and native-feeling DatoCMS plugin UI work through one reference bundle.
