...
async function main(){
 ...
 async function run(name,prompt,instructions,source){
  ...
  try {
   const result=await nativeSession({repoRoot:root,workspace,output:join(output,name),hostedMcp:SERVER,timeoutMs:420000,maxCommands:35,maxMcpCalls:40,prompt,instructions});
