...
Load `sdk-connect-and-frames.md` when you need exact frame, Canvas, or render-helper details. Load `sdk-context-and-cma.md` when you need context/API details, such as:
