...
Only enter this sub-task once the user has chosen the migration approach (see "Schema changes" in Step 2.5 of ../cli.md). Confirm these inputs when they are not already clear:
