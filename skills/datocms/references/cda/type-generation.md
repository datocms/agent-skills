...
For generating TypeScript types for CMA record operations (`datocms schema:generate`), see the CMA skill's `type-generation.md`. If the CMA skill is not installed, ask the user to install it.
