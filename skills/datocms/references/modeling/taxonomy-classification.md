...
Full validator/cascade reference: `../cma/schema.md`. Configuring on link / links / structured_text_links validators: `field-configuration.md` § Constrain links between records.

## Querying taxonomies

GraphQL read patterns (filtering by taxonomy, getting items in category-or-its-children, building category trees): see [CDA guide](../cda.md) skill. Query shapes belong there, not here.
