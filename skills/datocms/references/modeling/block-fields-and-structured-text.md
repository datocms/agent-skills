...
Full validator shapes and cascade-strategy: `../cma/schema.md`. Editor parameters (`nodes` / `marks` / `heading_levels`): `field-configuration.md` § structured_text editor parameters.

## DAST node cheatsheet

Modeling-relevant subset only. Full grammar (children rules, marks list, building/editing DAST): `../cma/editing-records.md` § DAST grammar.
