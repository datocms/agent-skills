_Internal recipe for [Setup guide](../../../references/setup.md). After parent skill selects `video-player` recipe and queues prerequisites from `../../../references/setup/recipe-manifest.json`._
...
- `../../../references/cda/client-and-config.md`
- `../../../references/cda/images-and-videos.md`

Then load matching supported video reference:

| Framework | Reference |
| - | - |
| Next.js / React | `../../../references/frontend/react-video-player.md` |
| Nuxt / Vue | `../../../references/frontend/vue-video-player.md` |
| SvelteKit | `../../../references/frontend/svelte-video-player.md` |
...
| Astro with React integration | `../../../references/frontend/react-content-link.md` |
...
| Astro with React integration | `../../../references/frontend/astro.md` |
