_Internal recipe for [Setup guide](../../../references/setup.md). Use only after parent skill selects `site-search` recipe and queues prerequisites from `../../../references/setup/recipe-manifest.json`._
...
1. **Framework and UI stack** — use `../../../references/setup/repo-conventions.md` for framework detection, then inspect whether `react-datocms`, `vue-datocms`, `@datocms/svelte`, or `@datocms/astro` installed. If none match, infer React-based, Vue-based, or other.
...
- `../../../references/frontend/site-search-api.md`
- `../../../references/cma/client-types-and-behaviors.md`
- `../../../references/cma/access-control.md`

Then load framework-appropriate search UI reference:

| Stack | Reference |
| - | - |
| React / Next.js | `../../../references/frontend/react-site-search.md` |
| Vue / Nuxt | `../../../references/frontend/vue-site-search.md` |
| SvelteKit / Astro / unsupported UI stack | `../../../references/frontend/site-search-api.md` |
