_Internal recipe for [Setup guide](../../../references/setup.md). Use only after parent skill selects `responsive-images` recipe and queues prerequisites from `../../../references/setup/recipe-manifest.json`._
...
| Framework | Reference |
| - | - |
| Next.js / React | `../../../references/frontend/react-image.md` |
| Nuxt / Vue | `../../../references/frontend/vue-image.md` |
| SvelteKit | `../../../references/frontend/svelte-image.md` |
| Astro | `../../../references/frontend/astro-image.md` |
