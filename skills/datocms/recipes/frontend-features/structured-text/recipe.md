_Internal recipe for [Setup guide](../../../references/setup.md). Use after parent skill selects `structured-text` and queues `../../../references/setup/recipe-manifest.json` prerequisites._
...
Follow repo inspection in `../../../references/setup/repo-conventions.md`, then inspect:
...
- `../../../references/cda/structured-text.md`

Then load matching framework reference:

| Framework | Reference |
| - | - |
| Next.js / React | `../../../references/frontend/react-structured-text.md` |
| Nuxt / Vue | `../../../references/frontend/vue-structured-text.md` |
| SvelteKit | `../../../references/frontend/svelte-structured-text.md` |
| Astro | `../../../references/frontend/astro-structured-text.md` |
