_Recipe for [Setup guide](../../../references/setup.md). Use only after parent skill selects `migrations` recipe and queues prerequisites from `../../../references/setup/recipe-manifest.json`._
...
- `../../../references/cli/creating-migrations.md`
