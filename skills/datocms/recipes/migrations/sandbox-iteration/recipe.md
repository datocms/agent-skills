_Internal recipe for [Setup guide](../../../references/setup.md). Use this file only after the parent skill selects the `sandbox-iteration` recipe and queues any prerequisites from `../../../references/setup/recipe-manifest.json`._
...
2. **Package manager** — See `../../../references/setup/mandatory-rules.md`.
...
- `../../../references/cli/running-migrations.md`
- `../../../references/cli/environment-commands.md`
- `../../../references/cli/deployment-workflow.md`
...
3. Keep production rollout separate by using [Setup guide](../../../references/setup.md) for `migration-release-workflow`
