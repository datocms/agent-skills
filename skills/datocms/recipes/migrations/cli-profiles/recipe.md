_Internal recipe for [Setup guide](../../../references/setup.md). Use after parent skill selects `cli-profiles` recipe & queues prerequisites from `../../../references/setup/recipe-manifest.json`._
...
Follow shared repo inspection in `../../../references/setup/repo-conventions.md`, then inspect:
...
Follow shared final handoff in `../../../references/setup/output-status.md`, including explicit `Unresolved placeholders` section.
