_Internal recipe for [Setup guide](../../../references/setup.md). Use this file only after the parent skill selects the `blueprint-sync` recipe and queues any prerequisites from `../../../references/setup/recipe-manifest.json`._
...
- `../../../references/cli/blueprint-sync.md`
