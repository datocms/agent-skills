_Recipe for [Setup guide](../../../references/setup.md). Use after parent skill selects `webhooks` recipe and queues prerequisites from `../../../references/setup/recipe-manifest.json`._
...
2. **Framework and file layout** — use `../../../references/setup/repo-conventions.md` for supported framework detection and `src/` usage when local receiver in scope
...
- `../../../references/cma/resource-gotchas.md` (§ Webhooks)
