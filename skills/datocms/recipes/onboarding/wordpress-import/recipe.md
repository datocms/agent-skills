_Internal recipe for [Setup guide](../../../references/setup.md). Use this file only after the parent skill selects the `wordpress-import` recipe and queues any prerequisites from `../../../references/setup/recipe-manifest.json`._
