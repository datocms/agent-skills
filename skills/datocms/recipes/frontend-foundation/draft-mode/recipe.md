_Internal recipe for [Setup guide](../../../references/setup.md). Use this file only after the parent skill selects the `draft-mode` recipe and queues any prerequisites from `../../../references/setup/recipe-manifest.json`._
...
Follow the shared repo inspection conventions in `../../../references/setup/repo-conventions.md`, then inspect the recipe-specific signals below.

1. **Framework and file layout** — use `../../../references/setup/repo-conventions.md` for supported framework detection, `src/` usage, and the standard draft-mode route locations.
...
Follow the zero-question default and question-format rules in `../../../references/setup/mandatory-rules.md`.
...
- `../../../references/frontend/draft-mode-concepts.md`
...
Follow the TypeScript rules in `../../../references/setup/mandatory-rules.md`.

#### Env var naming conventions

Follow the env conventions in `../../../references/setup/mandatory-rules.md`.
...
Follow the file conflict rules in `../../../references/setup/mandatory-rules.md`.
...
Use the project's package manager (see `../../../references/setup/mandatory-rules.md`).
...
Follow the shared final handoff rules in `../../../references/setup/output-status.md`, including an explicit `Unresolved placeholders` section.
