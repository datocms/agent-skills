Internal recipe for [Setup guide](../../../references/setup.md). Use after parent skill selects `realtime` recipe and queues prerequisites from `../../../references/setup/recipe-manifest.json`.
...
- `../../../references/frontend/realtime-concepts.md`
...
| - | - |
| Next.js (React) | `../../../references/frontend/react-realtime.md` |
| Nuxt (Vue) | `../../../references/frontend/vue-realtime.md` |
| SvelteKit | `../../../references/frontend/svelte-realtime.md` |
| Astro | `../../../references/frontend/astro-realtime.md` |
