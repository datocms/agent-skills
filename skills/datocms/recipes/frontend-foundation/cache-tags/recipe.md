_Internal recipe for [Setup guide](../../../references/setup.md). Use this file only after the parent skill selects the `cache-tags` recipe and queues any prerequisites from `../../../references/setup/recipe-manifest.json`._
...
Follow `../../../references/setup/repo-conventions.md`, then inspect:

1. **Framework and file layout** — use `../../../references/setup/repo-conventions.md`
...
Infer from repo first. Follow `../../../references/setup/mandatory-rules.md`. Ask zero questions only when hosting choice is obvious.
...
- `../../../references/cda/draft-caching-environments.md`
...
**TypeScript:** Follow `../../../references/setup/mandatory-rules.md`

**Env var naming:** Follow `../../../references/setup/mandatory-rules.md`
...
**File conflicts:** Follow `../../../references/setup/mandatory-rules.md`
...
Follow `../../../references/setup/output-status.md` for final handoff, including explicit `Unresolved placeholders` section.
