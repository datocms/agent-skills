_Internal recipe for [Setup guide](../../../references/setup.md). Use this file only after the parent skill selects the `cda-client` recipe and queues any prerequisites from `../../../references/setup/recipe-manifest.json`._
...
1. **Framework and file layout** — use `../../../references/setup/repo-conventions.md` for supported framework detection and `src/` usage.
