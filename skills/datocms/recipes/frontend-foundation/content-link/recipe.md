_Internal recipe for [Setup guide](../../../references/setup.md). Use after parent skill selects `content-link` recipe and queues prerequisites from `../../../references/setup/recipe-manifest.json`._
...
Follow shared repo inspection conventions in `../../../references/setup/repo-conventions.md`, then inspect recipe-specific signals.

1. **Framework/file layout** — use `../../../references/setup/repo-conventions.md` for framework detection, `src/` usage, and standard layout/route locations.
...
- `../../../references/frontend/visual-editing-concepts.md`
- `../../../references/frontend/content-link-concepts.md`

**Load per framework — focus on `## Content Link (Optional)` section:**

| Framework | Reference file |
| - | - |
| Next.js | `../../../references/frontend/nextjs.md` |
| Nuxt | `../../../references/frontend/nuxt.md` |
| SvelteKit | `../../../references/frontend/sveltekit.md` |
...
| - | - |
| Next.js (React) | `../../../references/frontend/react-content-link.md` |
| Nuxt (Vue) | `../../../references/frontend/vue-content-link.md` |
| SvelteKit | `../../../references/frontend/svelte-content-link.md` |
| Astro | `../../../references/frontend/astro-content-link.md` |
...
Use project's package manager (see `../../../references/setup/mandatory-rules.md`).
...
Follow TypeScript rules in `../../../references/setup/mandatory-rules.md`.

### File conflicts

Follow file conflict rules in `../../../references/setup/mandatory-rules.md`.
